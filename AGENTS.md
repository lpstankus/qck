...
- Current runtime ownership is UI-led for watcher, focus, tabbar, layout, and visibility behavior; terminal-specific code is limited to handle creation, id bookkeeping, and terminal buffer mappings.
